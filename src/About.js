          ...
          <section id="about" className="about-section d-flex align-items-center">
              <Container className="text-center">
                  ...
                  <p className="about-text">
                      ...
                      Currently pursuing a BS in Information Technology, I have experience in freelance developing; commissioning game development ranging from mobile to desktop platforms, IoT projects, desktop, and web applications.
